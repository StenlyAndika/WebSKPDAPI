        ...
        <div class="card-body">
            ...
            <div class="row align-items-center connecting-lines d-flex text-left">
                <div class="col-2 text-center bottom d-inline-flex justify-content-center align-items-center">
                    <?php if (strtotime(date('d F Y')) < strtotime(date('d F Y', strtotime($timelinetgl[0])))) : ?>
                        <div class="circle fw-bold" style="--colvar : #3E54AC;"><i class="fa fa-check"></i></div>
                    <?php elseif (strtotime(date('d F Y')) == strtotime(date('d F Y', strtotime($timelinetgl[0])))) : ?>
                        <div class="circle fw-bold" style="--colvar : #5BB318;"><i class="fa fa-check"></i></div>
                    <?php else : ?>
                        <div class="circle fw-bold" style="--colvar : #DC0000;"><i class="fa fa-check"></i></div>
                    <?php endif; ?>
                </div>
                <div class="col-10">
                    <?php if (strtotime(date('d F Y')) < strtotime(date('d F Y', strtotime($timelinetgl[0])))) : ?>
                        <h5 class="fw-bold" style="color: #3E54AC;"><?= $this->main->tgl_indo2($timelinetgl[0]); ?></h5>
                        <p>
                    ...
                    <?php elseif (strtotime(date('d F Y')) == strtotime(date('d F Y', strtotime($timelinetgl[0])))) : ?>
                        <h5 class="fw-bold" style="color: #5BB318;"><?= $this->main->tgl_indo2($timelinetgl[0]); ?></h5>
                        <p>
                    ...
                    <?php else : ?>
                        <h5 class="fw-bold text-muted"><?= $this->main->tgl_indo2($timelinetgl[0]); ?></h5>
                        <p>
            ...
            <div class="row align-items-center justify-content-end connecting-lines d-flex">
                ...
                <?php if (strtotime(date('d F Y')) < strtotime(date('d F Y', strtotime($timelinetgl[1])))) : ?>
                        <h5 class="fw-bold" style="color: #3E54AC;"><?= $this->main->tgl_indo2($timelinetgl[1]); ?></h5>
                        <p>
                    ...
                    <?php elseif (strtotime(date('d F Y')) == strtotime(date('d F Y', strtotime($timelinetgl[1])))) : ?>
                        <h5 class="fw-bold" style="color: #5BB318;"><?= $this->main->tgl_indo2($timelinetgl[1]); ?></h5>
                        <p>
                    ...
                    <?php else : ?>
                        <h5 class="fw-bold text-muted"><?= $this->main->tgl_indo2($timelinetgl[1]); ?></h5>
                        <p>
            ...
            <div class="row align-items-center connecting-lines d-flex text-left">
                ...
                <div class="col-10">
                <?php if (strtotime(date('d F Y')) < strtotime(date('d F Y', strtotime($timelinetgl[2])))) : ?>
                        <h5 class="fw-bold" style="color: #3E54AC;"><?= $this->main->tgl_indo2($timelinetgl[2]); ?></h5>
                        <p>
                    ...
                    <?php elseif (strtotime(date('d F Y')) == strtotime(date('d F Y', strtotime($timelinetgl[2])))) : ?>
                        <h5 class="fw-bold" style="color: #5BB318;"><?= $this->main->tgl_indo2($timelinetgl[2]); ?></h5>
                        <p>
                    ...
                    <?php else : ?>
                        <h5 class="fw-bold text-muted"><?= $this->main->tgl_indo2($timelinetgl[2]); ?></h5>
                        <p>
