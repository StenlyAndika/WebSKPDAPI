			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body card-block">            
                        <form method="post" action="{{ route('admin.kepuasan.store') }}">
                            @csrf
                            ...
                            <div class="form-floating mb-1">
                                <input type="text" class="form-control @error('predikat') is-invalid @enderror" id="predikat" name="predikat" placeholder="predikat" value="{{ old('predikat') }}">
