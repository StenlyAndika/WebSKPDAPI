                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('admin.service.create') }}" class="d-inline align-middle btn btn-sm btn-success mb-2"><i class="fa-solid fa-plus"></i></a>
                                ...
                                <table id="datatable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.service.edit', $row->id) }}" class="btn btn-block btn-sm btn-primary"><i class="fa-solid fa-pen"></i></a>
