			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body card-block">            
                        <form method="post" action="{{ route('admin.penghargaan.update', $penghargaan->slug) }}" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="form-floating mb-1">
                                <input type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" placeholder="Keterangan" value="{{ $penghargaan->keterangan }}">
                            ...
                            <div class="form-floating mb-1">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="Slug" value="{{ $penghargaan->slug }}" readonly>
                            ...
                            <div class="form-group mb-1">
                                ...
                                @enderror
                                <input type="hidden" name="oldFile" value="{{ $penghargaan->namafile }}">
                            </div>
