			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body card-block">            
                        <form method="post" action="{{ route('admin.domaindesa.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-sm btn-success" href="{{ route('admin.domaindesa.index') }}">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
